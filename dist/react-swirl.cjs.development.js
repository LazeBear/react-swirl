...
var ReactSwirl = function ReactSwirl(_ref) {
  ...
  var _useState3 = React.useState(initialOrderArray),
      orderArray = _useState3[0],
      setOrderArray = _useState3[1];

  var _useState4 = React.useState(reallocateOrder(children, orderArray)),
  ...
  return React__default.createElement(Wrapper, null, React__default.createElement(Container, {
    ref: targetRef,
    style: {
    ...
    }, React__default.createElement(ChildWrapper, null, i.child), React__default.createElement(Overlay, null));
  })), showNav && React__default.createElement(Nav, null, React__default.createElement(LastButton, {
    onClick: function onClick() {
      return slideToLast();
    }
  }, React__default.createElement("span", null)), React__default.createElement(NextButton, {
    onClick: function onClick() {
      return slideToNext();
    }
  }, React__default.createElement("span", null))), showDots && React__default.createElement(Dots, null, displayArray.map(function (_ref2) {
    ...
    }, React__default.createElement("span", null, "\xA0"));
  })));
};
